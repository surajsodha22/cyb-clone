...
function SoftwareServices() {
  ...
  return (
    <section className="sm:py-72 pt-72">
      {/* Heading */}
      <SectionHeading
      ...
      {/* Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3  gap-4 sm:gap-6 lg:gap-8  mx-auto">
        {softwareServices.map((service, index) => (
          <div
            key={index}
            className="bg-white rounded-xl w-full max-w-[385px] h-[292px]  p-4 sm:p-6 lg:p-8 relative bg-cover bg-no-repeat bg-center cursor-pointer transition-all duration-300 mx-auto"
            style={{
              backgroundImage:
          ...
          >
            ...
            <div className=" mt-4 sm:mt-6">
              <h3 className="text-lg font-bold text-gray-900 mb-3 sm:mb-4 leading-tight pr-24 ">
                {service.title}
              </h3>
              <p className="text-gray-600 text-base sm:text-sm leading-relaxed ms:pr-8 pr-[85px]">
