...
const WebsiteDevelopmentHero = ({title, description, image, pathname}) => {
  return (
    <section
    ...
    >
      ...
      <div className="w-full lg:w-1/2 mt-6 sm:mt-8 lg:mt-0 flex justify-center lg:justify-end">
        <div className="rounded-[20px] sm:rounded-[30px] overflow-hidden w-full max-w-sm sm:max-w-md lg:mr-5">
