...
const AIDevelopmentHero = ({title, description, image}) => {
  return (
    <section
      className={`flex flex-col lg:flex-row items-center justify-between py-8 sm:py-16 md:py-20`}
    >
      {/* Left Section */}
      ...
      <div className="w-full lg:w-1/2 mt-6 sm:mt-8 lg:mt-0 flex justify-center lg:justify-end">
        <div className="rounded-[20px] sm:rounded-[30px] overflow-hidden w-[96] max-w-sm sm:max-w-md lg:mr-24">
...
export default AIDevelopmentHero;
